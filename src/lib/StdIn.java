package lib; /******************************************************************************
 *  Compilation:  javac lib.StdIn.java
 *  Execution:    java lib.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 *  The {@code lib.StdIn} class provides static methods for reading strings
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code lib.StdIn.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdIn.java">lib.StdIn.java</a>
 ...
 *  <pre>
 *  while (!lib.StdIn.isEmpty()) {
 *      double value = lib.StdIn.readDouble();
 *      lib.StdOut.println(value);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (lib.StdIn.hasNextChar()) {
 *      char c = lib.StdIn.readChar();
 *      lib.StdOut.print(c);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (lib.StdIn.hasNextLine()) {
 *      String line = lib.StdIn.readLine();
 *      lib.StdOut.println(line);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  String[] words = lib.StdIn.readAllStrings();
 *  </pre>
 *  <p>
 *  <b>Differences with Scanner.</b>
 *  {@code lib.StdIn} and {@link Scanner} are both designed to parse
 *  tokens and convert them to primitive types and strings.
 *  The main differences are summarized below:
 *  <ul>
 *  <li> {@code lib.StdIn} is a set of static methods and reads
 ...
 *  Windows, and Linux.
 *  The methods in {@code lib.StdIn} are <em>blocking</em>, which means that they
 ...
 *  If the input begins with the optional byte-order mask, {@code lib.StdIn}
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from lib.In to lib.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from lib.In to lib.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from lib.In to lib.StdIn,
    ...
    public static char readChar() {
        try {
            ...
            assert ch.length() == 1 : "Internal (Std)lib.In.readChar() error!"
    ...
    //// end: section (2 of 2) of code duplicated from lib.In to lib.StdIn


    // do this once when lib.StdIn is initialized
    static {
        resync();
    }

    /**
     * If lib.StdIn changes, use this to reinitialize the scanner.
     */
